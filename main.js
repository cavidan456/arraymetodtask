...
// const sortMetods = results.sort((a,b) => a.order.employeeId - b.order.employeeId)

// console.log(sortMetods);

//4) OrderDetailsi 3-dən çox olanları console-a yazdır

// const exemple1 = results.filter(item => item.orderDetails.length > 3);
// console.log(exemple1);

// sual 5 helli

// const productId = results.find(product => product.order.id  === 11074);
